...
export type Database = {
  chat: {
    ...
    Functions: {
      create_channel: {
        Args: { channel: string; user1: string; user2: string }
        Returns: undefined
      }
      delete_channel: { Args: { channel: string }; Returns: undefined }
    }
    Enums: {
      [_ in never]: never
    }
  ...
  public: {
    Tables: {
      ...
      profile_ethnicities: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_ethnicities_ethnicity_fkey"
    ...
    Functions: {
      ...
      checkUser: { Args: never; Returns: boolean }
      ...
      update_location: {
        Args: { latitude: number; longitude: number; neighbourhood: string }
        Returns: undefined
      }
      update_profile: {
        Args: {
